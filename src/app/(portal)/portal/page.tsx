...
export default async function ClientPortalHomePage() {
  ...
  try {
    ...
    console.warn('Prisma portal error:', e);
  }
  ...
  if (!client) {
    client = {
      ...
      socialConnections: [{ id: 'sc1', platform: 'INSTAGRAM' }],
      reports: [
        {
          ...
          metrics: [
            { metricKey: 'reach', currentValue: 184500 },
            { metricKey: 'impressions', currentValue: 246000 },
            { metricKey: 'interactions', currentValue: 12580 },
            { metricKey: 'engagement', currentValue: '6.82' }
          ],
          recommendations: [
            {
              id: 'rec-1',
